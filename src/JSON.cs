    ...
    public static class JSON
    {
        ...
        sealed class Serializer
        {
            ...
            void SerializeValue(object value)
            {
                ...
                else if ((asArr = value as List<object>) != null)
                {
                    SerializeArray(asArr);
                }
            ...
            void SerializeObject(Dictionary<string, object> dict)
            {
                ...
                {
                    if (dict[key] == null || dict[key].GetType().Name != "Action")
                    {
                        if (!first)
                        {
                            builder.Append(',');
            ...
            void SerializeArray(List<object> anArray, int level = 0)
            {
                builder.Append('[');
                bool first = true;
